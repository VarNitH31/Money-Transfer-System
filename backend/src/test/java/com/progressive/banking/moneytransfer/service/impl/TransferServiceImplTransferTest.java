...
class TransferServiceImplTransferTest {
    ...
    void transfer_duplicateIdempotencyKey_throwsDuplicateTransferException() {
        ...
        assertThrows(DuplicateTransferException.class, () -> transferService.transfer(req,"User 1"));
    ...
    void transfer_fromAccountMissing_throwsNotFound() {
        ...
        assertThrows(AccountNotFoundException.class, () -> transferService.transfer(req,"User 1"));
    ...
    void transfer_validRequest_returnsSuccessResponse() {
        ...
        TransferResponse response = transferService.transfer(req,"User 1");
